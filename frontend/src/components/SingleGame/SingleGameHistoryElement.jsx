...
const SingleGameHistoryElement = ({ game }) => {
  return (
    <div className="text-base border-2 border-white p-2 mx-4 md:w-[30rem] rounded-xl shadow-xl bg-indigo-300 flex gap-4 md:gap-10 items-center mt-2">
      <Avatar
        variant="circular"
      ...
      <div className="flex flex-col md:text-lg font-bold">
        ...
        <p className="text-lg md:text-xl">{game.player1Score}</p>
      </div>
      <div className="flex flex-col md:text-lg font-bold">
        <p className="opacity-70">Rounds</p>
        <p className="text-lg md:text-xl">{game.rounds}</p>
      </div>
