...
const RoomNameWithScore = ({ name, round, score, handleGameEnd }) => {
  return (
    <Card className="absolute z-20 top-8 right-0 w-128 bg-gradient-to-b from-indigo-400 via-indigo-500 to-indigo-700 text-white shadow-lg divide-y divide-indigo-300">
      <CardBody className="flex gap-8 justify-center pb-4">
